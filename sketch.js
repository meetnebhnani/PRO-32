...
function setup() {
  ...
  //First level
  block1=new Box1(300+60,275,30,40);
  block2=new Box1(330+60,275,30,40);
  block3=new Box1(360+60,275,30,40);
  block4=new Box1(390+60,275,30,40);
  block5=new Box1(420+60,275,30,40);
  block6=new Box1(450+60,275,30,40);
  block7=new Box1(480+60,275,30,40);

  //Second level
  block8=new Box2(330+60,235,30,40);
  block9=new Box2(360+60,235,30,40);
  block10=new Box2(390+60,235,30,40);
  block11=new Box2(420+60,235,30,40);
  block12=new Box2(450+60,235,30,40);

  //Third level
  block13=new Box4(360+60,195,30,40);
  block14=new Box4(390+60,195,30,40);
  block15=new Box4(420+60,195,30,40);
  ...
  //Bottom level
  block17=new Box1(800-60,205,30,40);
  block18=new Box1(800-30,205,30,40);
  block19=new Box1(800,205,30,40);
  block20=new Box1(800+30,205,30,40);
  block21=new Box1(800+60,205,30,40);
  ...
  //Top level
  block25=new Box3(800,205-80,30,40);
...
function draw() {
  ...
  fill(txtcolor);
  textSize(22);
  text("DRAG THE STONE TOWARDS TOWER AND RELEASE IT,SIEGE THE TOWER COMPLETELY",150,30);
...
async function fetchtime(){
    ...
    console.log(hour);
    //var hour=data.currentDateTime.slice(11,13);
    if(hour>=06 && hour<=16) {
      bg=color("yellow")
      txtcolor=color("black")
    }
